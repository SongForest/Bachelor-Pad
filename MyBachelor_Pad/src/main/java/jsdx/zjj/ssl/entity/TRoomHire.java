...
public class TRoomHire {
    ...
    private String majorRoomer;

    private Date hireStarttime;

    private Date hireFinaltime;
    ...
    public String getMajorRoomer() {
        return majorRoomer;
    }

    public void setMajorRoomer(String majorRoomer) {
        this.majorRoomer = majorRoomer == null ? null : majorRoomer.trim();
    }
    ...
    public Date getHireFinaltime() {
        return hireFinaltime;
    }

    public void setHireFinaltime(Date hireFinaltime) {
        this.hireFinaltime = hireFinaltime;
    }
    ...
    public Integer getRoomerAmount() {
        return roomerAmount;
    }

    public void setRoomerAmount(Integer roomerAmount) {
